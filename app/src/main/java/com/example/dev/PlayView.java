...
public class PlayView extends GLSurfaceView {
	...
	public boolean isCanDrawFrame = true; // false:不需要再刷屏
    private boolean isRenderInited = false; // render初始�?
...
;
        ...
        //setGestureListenner();// 当窗口获取焦点或监听
    }
...
private static int[] s_configAttribs2 = {EGL10.EGL_RED_SIZE, 4,
    ...
    private class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            if (isCanDrawFrame && isRenderInited) {
            	NetDEVSDK.rendererRender();
